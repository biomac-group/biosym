...
trial: Subject2_trial1
  - Avg. Marker RMSE      = 3.74 cm
  - Avg. Marker Max Error = 7.59 cm
  - WARNING: 9 marker(s) with RMSE greater than 4 cm!
  - WARNING: Automatic data processing required modifying TRC data from 5 marker(s)!
  --> See IK/Subject2_trial1_ik_summary.txt for more details.

trial: Subject2_trial2
  - Avg. Marker RMSE      = 3.48 cm
  - Avg. Marker Max Error = 6.49 cm
  - WARNING: 6 marker(s) with RMSE greater than 4 cm!
  - WARNING: Automatic data processing required modifying TRC data from 78 marker(s)!
  --> See IK/Subject2_trial2_ik_summary.txt for more details.
...
to verify IK results for each trial:
 ...
 > opensim-cmd run-tool Subject2_trial1_ik_setup.xml
           # This will create a results file IK/Subject2_trial1_ik_by_opensim.mot
 > opensim-cmd run-tool Subject2_trial2_ik_setup.xml
           # This will create a results file IK/Subject2_trial2_ik_by_opensim.mot
...
not including the leading "> "):
 ...
 > opensim-cmd run-tool Subject2_trial1_id_setup.xml
           # This will create a results file ID/Subject2_trial1_id.sto
 > opensim-cmd run-tool Subject2_trial2_id_setup.xml
           # This will create a results file ID/Subject2_trial2_id.sto
