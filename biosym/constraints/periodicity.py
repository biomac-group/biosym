...
class Constraint(BaseConstraint):
    ...
    def get_jacobian(self):
        ...
        return jax.jit(
            partial(
                jacobian_per,
                dims=self.dims,
                id_symmetry=self.id_symmetry,
                nnodes_dur=self.settings["nnodes_dur"],
    ...
    def get_nnz(self):
        ...
        """
        return (
            2 * self.get_n_constraints()
        )  # Each constraint has two non-zero entries (start and end of the periodicity)
