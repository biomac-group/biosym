...
.. "auto_examples/plot_model_comparison_optimization.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_model_comparison_optimization.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_model_comparison_optimization.py:
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/Users/markusgambietz/PhD/01_Python_Projects/biosym/examples/plot_model_comparison_optimization.py", line 18, in <module>
        sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))
...
.. GENERATED FROM PYTHON SOURCE LINES 50-131
...
.. GENERATED FROM PYTHON SOURCE LINES 137-254
...
.. GENERATED FROM PYTHON SOURCE LINES 259-292
...
.. GENERATED FROM PYTHON SOURCE LINES 297-350
...
.. GENERATED FROM PYTHON SOURCE LINES 355-467
...
.. GENERATED FROM PYTHON SOURCE LINES 472-494
...
.. _sphx_glr_download_auto_examples_plot_model_comparison_optimization.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_model_comparison_optimization.ipynb <plot_model_comparison_optimization.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_model_comparison_optimization.py <plot_model_comparison_optimization.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_model_comparison_optimization.zip <plot_model_comparison_optimization.zip>`
